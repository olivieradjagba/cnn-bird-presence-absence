...
class Preprocessing:
    ...
    def __init__(self, species_folder, lowpass_cutoff, 
                 ...
                 file_type, audio_extension, data_type='train'): # data_type = train or test
        ...
        self.training_files = self.species_folder + '/DataFiles/' + \
            ('TrainingFiles.txt' if data_type == 'train' else 'TestingFiles.txt')
        self.n_ftt = n_fft
